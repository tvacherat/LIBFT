...
/*   Updated: 2020/12/24 12:27:08 by tvachera         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				manage_signed(t_print print, long long nb);
...
char			*add_flags(t_print print, char *nbr, bool is_neg);
...
bool			in_str(char c, const char *str);
...
char			*strndup2(const char *s1, size_t n, bool active);
